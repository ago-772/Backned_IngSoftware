 ...
 *
 * <p>Persists via {@link TelemetryRepository} and returns {@link TelemetryResponseDto} only — never
 * JPA entities.
 */
@Service
public class TelemetryService {
  ...
  public TelemetryService(
      TelemetryRepository telemetryRepository, MateSessionRepository mateSessionRepository) {
  ...
  public List<TelemetryResponseDto> findAll() {
    List<TelemetryEntity> entities =
        telemetryRepository.findAll(Sort.by(Sort.Direction.DESC, "createdAt"));
