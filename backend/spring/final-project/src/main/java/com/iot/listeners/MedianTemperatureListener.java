...
/**
 * Observer that reacts to a closed session and computes
 * the median temperature from all telemetry readings
...
public class MedianTemperatureListener implements SessionObserver {
    ...
    /**
     * Computes the median temperature from a list of telemetry readings.
     * Sorts values and picks the middle element, or averages the two middle
     * elements if the list has an even number of readings.
     */
